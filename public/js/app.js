...
$(function () {
    ...
    $('*[data-deletable-comment]').each(function (index, obj) {
        console.log(obj);
        var name = $(obj).data('name');

        var message = 'Do you really want to delete this comment by "' + name + '?"';
    ...
    $('*[data-deletable-post]').each(function (index, obj) {
        var title = $(obj).data('title');

        var message = 'Do you really want to delete the post "' + title + '?"';
    ...
    $('*[data-deletable-photo]').each(function (index, obj) {
      ...
      _c(
        ...
        _vm._l(_vm.post_photos, function(photo) {
          return _c("div", { staticClass: "box-sortable" }, [
            _c(
              "a",
              { attrs: { href: _vm.asset_path + photo.path, target: "blank" } },
              [
                _c("img", {
